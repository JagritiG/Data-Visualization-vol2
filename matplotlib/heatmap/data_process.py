...
disease_2018 = raw_data[raw_data['Year'] == 2018]
print(disease_2018.head())
print(disease_2018.info())

# Create a DataFrame with SEX='TOTAL'
disease_total = disease_2018[disease_2018['Sex'] == 'TOTAL']
...
disease_countywise = disease_atleast_one_case.loc[['ALAMEDA', 'LOS ANGELES', 'SAN DIEGO']]
...
selected_disease = disease_countywise.loc[['Amebiasis', 'Dengue Virus Infection', 'Zika Virus Infection']]
selected_disease.reset_index(inplace=True)
print(selected_disease.head())
print(selected_disease.info())

# Save DataFrame into csv file
selected_disease.to_csv('selected_disease_countywise_2018.csv')
